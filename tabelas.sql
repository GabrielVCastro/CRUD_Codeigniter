...
-- Copiando estrutura para tabela sql_3.aeronave
CREATE TABLE IF NOT EXISTS `aeronave` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prefixo` varchar(50) NOT NULL,
  `tipo` enum('P','C') NOT NULL,
  `horas_voo` decimal(20,2) NOT NULL,
  `ano_fabricacao` int(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_3.aeronave: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `aeronave` DISABLE KEYS */;
/*!40000 ALTER TABLE `aeronave` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_3.cidade
...
-- Copiando dados para a tabela sql_3.cidade: ~5.564 rows (aproximadamente)
...
-- Copiando estrutura para tabela sql_3.estado
...
-- Copiando dados para a tabela sql_3.estado: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela sql_3.manutencao
...
-- Copiando dados para a tabela sql_3.manutencao: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `manutencao` DISABLE KEYS */;
/*!40000 ALTER TABLE `manutencao` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_3.missoes
CREATE TABLE IF NOT EXISTS `missoes` (
  ...
  CONSTRAINT `missoes_ibfk_1` FOREIGN KEY (`id_piloto`) REFERENCES `piloto` (`id`),
  CONSTRAINT `missoes_ibfk_2` FOREIGN KEY (`id_aeronave`) REFERENCES `aeronave` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_3.missoes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `missoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `missoes` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_3.pais
...
-- Copiando dados para a tabela sql_3.pais: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela sql_3.piloto
CREATE TABLE IF NOT EXISTS `piloto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL,
  `data_nascimento` date NOT NULL,
  `sexo` enum('M','F') NOT NULL,
  `qualificacao` enum('C-P','C') NOT NULL,
  `ultimo_exame` date NOT NULL,
  `telefone` int(22) NOT NULL,
  `endereco` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_3.piloto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `piloto` DISABLE KEYS */;
/*!40000 ALTER TABLE `piloto` ENABLE KEYS */;

-- Copiando estrutura para tabela sql_3.tecnico
CREATE TABLE IF NOT EXISTS `tecnico` (
  ...
  `exame_medico` date NOT NULL,
  `qualificaçao` varchar(20) NOT NULL,
  `telefone` int(22) NOT NULL,
  `endereco` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela sql_3.tecnico: ~0 rows (aproximadamente)
