...
<div class="container-fluid">
  <div class="row">
    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 offset-md-2 col-md-8 col-sm-12 col-12">
      <form action="<?= base_url('index.php/Missao/cadastrar') ?>" method="POST">
        <h2>Cadastrar Missão</h2>
        <label for="data_hora_partida">Data/Hora da Partida</label>
        <input type="text" class="form-control date_time " name="data_partida" id="data_hora_partida"><br>
        <label for="data_hora_chegada">Data/Hora de Chegada</label>
        <input type="text" class="form-control date_time " name="data_chegada" id="data_hora_chegada"><br>
        <label for="tipo">Tipo da Missão</label>
        <textarea name="tipo" id="tipo" cols="30" rows="5" class="form-control"></textarea><br>
